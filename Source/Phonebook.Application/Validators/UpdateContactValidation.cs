...
namespace Phonebook.Application.Validators
{
    public class UpdateContactCommandValidator : AbstractValidator<UpdateContactCommand>
    {
        ...
        {
            RuleFor(x => x.ContactRequest.Name).NotEmpty().WithMessage("Nome é obrigatório");
            RuleFor(x => x.ContactRequest.Phone).NotEmpty().WithMessage("Telefone é obrigatório");
            ...
            RuleFor(x => x.ContactRequest.Addresses)
                .NotNull()
